...
export function BottomNav() {
  ...
  return (
    <motion.nav 
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-amber-500/40 bg-zinc-950/95 backdrop-blur-2xl shadow-[0_-20px_60px_rgba(0,0,0,0.95)]"
    >
            ...
            >
              {active && (
                <motion.div
                  ...
                  className="absolute inset-x-0.5 top-0 bottom-0 rounded-2xl bg-gradient-to-b from-amber-400/25 via-amber-500/10 to-transparent border border-amber-400/60 shadow-[0_0_30px_rgba(245,158,11,0.4),inset_0_0_15px_rgba(245,158,11,0.15)] -z-10"
