...
export function BottomNav() {
  ...
  return (
    <motion.nav 
      ...
      className="fixed inset-x-0 bottom-0 z-50 border-t border-amber-500/40 bg-zinc-950/95 backdrop-blur-2xl shadow-[0_-20px_60px_rgba(0,0,0,0.95)] pb-[env(safe-area-inset-bottom)]"
    >
