      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900 p-6 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <button
            ...
            className="flex items-center justify-center gap-1 rounded-lg bg-gradient-to-b from-amber-400 to-amber-500 px-2 py-2.5 text-[11px] font-bold text-black transition hover:from-amber-300 hover:to-amber-400"
          >
            <ArrowDownToLine className="h-3.5 w-3.5 shrink-0" /> <span className="truncate">Deposit</span>
          </button>
          <button
            onClick={() => openModal('withdraw')}
            className="flex items-center justify-center gap-1 rounded-lg border border-zinc-700 bg-zinc-800 px-2 py-2.5 text-[11px] font-bold text-zinc-200 transition hover:bg-zinc-700"
          >
