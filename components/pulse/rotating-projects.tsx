    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 gap-4">
        ...
        <div className="flex items-center gap-3 self-end sm:self-auto">
          ...
          <button 
            onClick={handlePrev}
            className="size-10 rounded-2xl border border-white/10 bg-white/[0.03] flex items-center justify-center text-zinc-300 hover:bg-white/[0.08] hover:border-amber-500/40 hover:text-amber-400 transition-all shadow-lg active:scale-95"
      ...
      {/* Main Container Card */}
      <div className="relative rounded-[28px] sm:rounded-[32px] border border-white/[0.08] bg-zinc-950/90 backdrop-blur-3xl overflow-hidden shadow-[0_30px_90px_rgba(0,0,0,0.9)] group">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="lg:col-span-5 relative w-full h-64 sm:h-72 lg:h-80 rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-zinc-900">
              ...
              {/* Floating Badge */}
              <div className="absolute top-4 left-4 z-20 bg-zinc-950/85 backdrop-blur-xl border border-amber-500/40 px-3 py-1.5 rounded-full text-xs font-semibold text-amber-300 shadow-xl flex items-center gap-1.5">
              ...
              <div className="absolute bottom-4 left-4 right-4 z-20 flex items-center justify-between gap-2 text-xs text-zinc-200 font-medium">
                <div className="flex items-center gap-1.5 bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10 truncate">
                  <MapPin className="size-3.5 text-amber-400 shrink-0" />
                  <span className="truncate">{currentProject.location}</span>
                </div>
                <div className="bg-black/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10 font-mono text-emerald-400 shrink-0">
            ...
            <div className="lg:col-span-7 flex flex-col justify-between space-y-5 sm:space-y-6">
              <div>
                <div className="flex flex-wrap items-center justify-between gap-2 mb-3">
                  <div className="inline-flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/30 px-3 py-1 rounded-xl text-emerald-300 font-mono text-xs font-semibold">
                ...
                <p className="mt-2 text-xs sm:text-sm text-zinc-400 leading-relaxed text-pretty">
              ...
              <div className="grid grid-cols-3 gap-2.5 sm:gap-3 font-mono text-xs">
                <div className="bg-white/[0.02] p-3 rounded-2xl border border-white/10 hover:border-amber-500/30 transition-colors">
                  <span className="text-zinc-500 block text-[10px] mb-0.5">Projected IRR</span>
                  <span className="text-amber-400 font-bold text-sm sm:text-base">{currentProject.metrics.irr}</span>
                </div>
                <div className="bg-white/[0.02] p-3 rounded-2xl border border-white/10 hover:border-amber-500/30 transition-colors">
                  <span className="text-zinc-500 block text-[10px] mb-0.5">Lockup Term</span>
                ...
                <div className="bg-white/[0.02] p-3 rounded-2xl border border-white/10 hover:border-amber-500/30 transition-colors">
                  <span className="text-zinc-500 block text-[10px] mb-0.5">Risk Rating</span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-mono">
                  <span className="text-zinc-400">Syndicate Pool: <strong className="text-white">${currentProject.raisedAmount.toLocaleString()}</strong></span>
                ...
                <div className="h-2.5 w-full bg-white/5 rounded-full overflow-hidden p-0.5 border border-white/10">
                  <motion.div 
                    ...
                    className="h-full bg-gradient-to-r from-amber-600 via-amber-500 to-amber-300 rounded-full shadow-[0_0_15px_rgba(245,158,11,0.6)]"
                  />
                </div>
              </div>
